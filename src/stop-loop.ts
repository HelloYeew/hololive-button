...
@customElement('stop-loop')
export class StopLoop extends LitElement {
    ...
    static get styles() {
        return css`
            ...
            #button {
                ...
                box-shadow: 0 2px 4px #FF000070, 0 4px 16px #FF000050,
                    0 16px 40px #FF000050;
                border: 0;
                outline: none;
                cursor: pointer;
            ...
            #button:hover,
            #button:focus {
                box-shadow: 0 2px 4px #FF000080, 0 20px 48px #FF000060,
                    0 16px 40px #FF000060;
            }
            #title {
